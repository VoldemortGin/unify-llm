...
class BaseTrigger:
    ...
    Example:
        ```python
        from src.agent.triggers import BaseTrigger, TriggerEvent
...
class ScheduleTrigger(BaseTrigger):
    ...
    Example:
        ```python
        from src.agent.triggers import ScheduleTrigger, TriggerConfig, TriggerType
...
class TriggerManager:
    ...
    Example:
        ```python
        from src.agent.triggers import TriggerManager
