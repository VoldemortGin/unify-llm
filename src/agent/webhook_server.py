...
from src.agent.triggers import WebhookTrigger
...
class WebhookServer:
    ...
    Example:
        ```python
        from src.agent.webhook_server import WebhookServer
        from src.agent.triggers import WebhookTrigger, TriggerConfig, TriggerType
...
class WebhookClient:
    ...
    Example:
        ```python
        from src.agent.webhook_server import WebhookClient
