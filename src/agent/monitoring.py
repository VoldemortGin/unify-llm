...
class PerformanceMonitor:
    ...
    Example:
        ```python
        from src.agent.monitoring import PerformanceMonitor
...
class ExecutionLogger:
    ...
    Example:
        ```python
        from src.agent.monitoring import ExecutionLogger
    ...
    def get_failed_executions(self, agent_name: Optional[str] = None) -> List[Dict]:
