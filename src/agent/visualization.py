...
from src.agent.workflow import NodeType, Workflow
...
class WorkflowVisualizer:
    ...
    Example:
        ```python
        from src.agent.visualization import WorkflowVisualizer
...
class ExecutionTracer:
    ...
    Example:
        ```python
        from src.agent.visualization import ExecutionTracer
