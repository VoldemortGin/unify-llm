...
class ExecutionData(BaseModel):
    ...
    trigger_type: Optional[str] = Field(default=None, description="Trigger type")
...
class ExecutionHistory:
    ...
    Example:
        ```python
        from src.agent.execution_history import ExecutionHistory, ExecutionData, ExecutionStatus
    ...
    def get(self, execution_id: str) -> Optional[ExecutionData]:
        """Get execution by ID.
    ...
    def get_recent(self, limit: int = 50, status: Optional[str] = None) -> List[ExecutionData]:
